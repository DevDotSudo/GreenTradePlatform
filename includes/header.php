            ...
            <div class="header-top-content">
                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    <form id="logout-form" method="POST" action="/logout.php" style="display:inline;">
                        <button type="button" class="btn btn-logout" id="logout-btn" aria-haspopup="dialog" aria-controls="confirm-logout-modal">Logout</button>
                    </form>
                <?php else: ?>
                ...
                <?php if ($userType === 'buyer'): ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['PHP_SELF']) === 'orders.php' ? 'active' : ''; ?>" href="/buyer/orders.php">Orders</a>
                                        ...
                                        <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['PHP_SELF']) === 'settings.php' ? 'active' : ''; ?>" href="/settings.php">Profile</a>
                    </li>
                    <li class="nav-item">
...
<!-- Confirmation modal and JS handled inline below -->
